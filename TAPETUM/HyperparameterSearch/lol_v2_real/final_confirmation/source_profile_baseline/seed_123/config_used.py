...
if DATA_VARIANT is None:
    RUN_ROOT = '/content/retinextapetum_hpo/projects/lol_v2_real/final/source_profile_baseline_seed_123/run'
else:
    RUN_ROOT = '/content/retinextapetum_hpo/projects/lol_v2_real/final/source_profile_baseline_seed_123/run'
...
CKPT_DIR = '/content/retinextapetum_hpo/projects/lol_v2_real/final/source_profile_baseline_seed_123/run/checkpoints'

RESULT_DIR = '/content/retinextapetum_hpo/projects/lol_v2_real/final/source_profile_baseline_seed_123/run/results/Test'
