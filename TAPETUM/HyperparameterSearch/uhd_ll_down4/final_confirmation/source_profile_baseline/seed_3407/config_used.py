...
if DATA_VARIANT is None:
    RUN_ROOT = '/content/retinextapetum_hpo/projects/uhd_ll_down4/final/source_profile_baseline_seed_3407/run'
else:
    RUN_ROOT = '/content/retinextapetum_hpo/projects/uhd_ll_down4/final/source_profile_baseline_seed_3407/run'
...
CKPT_DIR = '/content/retinextapetum_hpo/projects/uhd_ll_down4/final/source_profile_baseline_seed_3407/run/checkpoints'

RESULT_DIR = '/content/retinextapetum_hpo/projects/uhd_ll_down4/final/source_profile_baseline_seed_3407/run/results/Test'
