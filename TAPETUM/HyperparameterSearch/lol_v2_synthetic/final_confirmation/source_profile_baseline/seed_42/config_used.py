...
if DATA_VARIANT is None:
    RUN_ROOT = '/content/retinextapetum_hpo/projects/lol_v2_synthetic/final/source_profile_baseline_seed_42/run'
else:
    RUN_ROOT = '/content/retinextapetum_hpo/projects/lol_v2_synthetic/final/source_profile_baseline_seed_42/run'
...
CKPT_DIR = '/content/retinextapetum_hpo/projects/lol_v2_synthetic/final/source_profile_baseline_seed_42/run/checkpoints'

RESULT_DIR = '/content/retinextapetum_hpo/projects/lol_v2_synthetic/final/source_profile_baseline_seed_42/run/results/Test'
